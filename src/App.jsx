...
import Wishlist from './features/wishlist/Wishlist'; // Import karo
// Cart Provider Import
...
function App() {
  return (
    <>
      <div>
        {/* CRITICAL: CartProvider sauthi upar hovo joiye jethi Layout/Navbar eni andar aavi jay */}
        <CartProvider>
          <Layout>
            <Routes>
